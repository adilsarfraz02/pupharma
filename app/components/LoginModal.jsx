...
import { Tabs, Tab, Card, CardBody, Modal, ModalContent, Button, useDisclosure, Input, Link, Tooltip } from "@nextui-org/react";
export default function Login() {
    ...
    return (
        <div className="flex flex-col w-fit">
            <Tooltip showArrow={true} color='foreground' content="Signin / Signup">
                <Button onClick={onOpen} variant="shadow" className='btn-main'>
                    Sign In
                </Button>
            </Tooltip>
            <Modal
                ...
                placement="center"
                backdrop="blur"
                className="mx-5 h-fit"
            >
                <ModalContent className="h-[60vh]">
                    <main className="bg-black/50 w-full flex flex-col items-center  py-2">
                        <div className="max-w-sm w-full text-gray-600 space-y-8">
                            <div className="text-center">
                                <div className="mt-14">
                                    <h3 className="text-white text-2xl font-bold sm:text-3xl">Log in to your account</h3>
                                    <p color="foreground">Don't have an account? <br /><label for="email" className="cursor-pointer font-medium text-purple-600 hover:text-purple-500">Sign up ⬇️</label></p>
                                </div>
                            </div>
                            <div className="space-y-4 text-sm font-medium">
                                <Button className="w-full flex items-center justify-center gap-x-3 py-2.5 border rounded-lg bg-gray-50 duration-150 text-black active:bg-gray-100">
                            ...
                            <p className="text-center text-gray-50"> Pupharma - <Link href="/privacyPolicy" color="foreground" className="opacity-20">Privacy Policy</Link></p>
                        </div>
                    </main>
                </ModalContent>
            </Modal>
